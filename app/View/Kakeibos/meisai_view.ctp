...
<table id="meisai_table">
    ...
    <tr>
        ...
        <th>合計</th>
        <td><?php print array_sum(Hash::extract($cashRecords, "Meisai.{s}.{n}.money")); ?></th>
        <td><?php print array_sum(Hash::extract($creditRecords, "Meisai.{s}.{n}.money")); ?></td>
    </tr>
</table><!--meisai_table-->
...
<table id="meisai_table">
    ...
    <?php foreach($records as $record): ?>
        <tr>
            ...
            <td><?php print $record['Kakeibo']['money']; ?></td>
